...
class Persons extends Table with TableInfo<Persons, PersonsData> {
  ...
  late final GeneratedColumn<String> optionalRules = GeneratedColumn<String>(
    'optional_rules',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  PersonsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PersonsData(
      ...
      optionalRules: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}optional_rules'],
      ),
...
class PersonsData extends DataClass implements Insertable<PersonsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || optionalRules != null) {
      map['optional_rules'] = Variable<String>(optionalRules);
    }
  ...
  PersonsCompanion toCompanion(bool nullToAbsent) {
    return PersonsCompanion(
      ...
      notes: notes == null && nullToAbsent
          ? const Value.absent()
          : Value(notes),
      optionalRules: optionalRules == null && nullToAbsent
          ? const Value.absent()
          : Value(optionalRules),
  ...
  factory PersonsData.fromJson(
    ...
    return PersonsData(
      ...
      optionalRules: serializer.fromJson<String?>(json['optionalRules']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'optionalRules': serializer.toJson<String?>(optionalRules),
  ...
  PersonsData copyWith({
    ...
    Value<String?> optionalRules = const Value.absent(),
    String? species,
  }) => PersonsData(
    id: id ?? this.id,
    name: name ?? this.name,
    ...
    optionalRules: optionalRules.present
        ? optionalRules.value
        : this.optionalRules,
  ...
  PersonsData copyWithCompanion(PersonsCompanion data) {
    return PersonsData(
      ...
      optionalRules: data.optionalRules.present
          ? data.optionalRules.value
          : this.optionalRules,
  ...
  String toString() {
    return (StringBuffer('PersonsData(')
          ...
          ..write('sex: $sex, ')
          ..write('notes: $notes, ')
          ..write('optionalRules: $optionalRules, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, dateOfBirth, sex, notes, optionalRules, species);
  @override
  bool operator ==(Object other) =>
      ...
      (other is PersonsData &&
          ...
          other.optionalRules == this.optionalRules &&
...
class PersonsCompanion extends UpdateCompanion<PersonsData> {
  ...
  final Value<String?> optionalRules;
  ...
  const PersonsCompanion({
    ...
    this.optionalRules = const Value.absent(),
  ...
  static Insertable<PersonsData> custom({
    ...
    Expression<String>? optionalRules,
    ...
    return RawValuesInsertable({
      ...
      if (optionalRules != null) 'optional_rules': optionalRules,
  ...
  PersonsCompanion copyWith({
    ...
    return PersonsCompanion(
      ...
      optionalRules: optionalRules ?? this.optionalRules,
      species: species ?? this.species,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (optionalRules.present) {
      map['optional_rules'] = Variable<String>(optionalRules.value);
    }
    if (species.present) {
...
class OwnAppointments extends Table
    with TableInfo<OwnAppointments, OwnAppointmentsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  OwnAppointments(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> firstOn = GeneratedColumn<String>(
    'first_on',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'own_appointments';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  OwnAppointmentsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return OwnAppointmentsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
      ...
      firstOn: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}first_on'],
      )!,
  ...
  @override
  OwnAppointments createAlias(String alias) {
    return OwnAppointments(attachedDatabase, alias);
  }
...
class OwnAppointmentsData extends DataClass
    implements Insertable<OwnAppointmentsData> {
  final String id;
  final String personId;
  final String title;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['first_on'] = Variable<String>(firstOn);
  ...
  OwnAppointmentsCompanion toCompanion(bool nullToAbsent) {
    return OwnAppointmentsCompanion(
      id: Value(id),
      personId: Value(personId),
      title: Value(title),
      firstOn: Value(firstOn),
      everyMonths: Value(everyMonths),
      note: note == null && nullToAbsent ? const Value.absent() : Value(note),
    );
  }

  factory OwnAppointmentsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return OwnAppointmentsData(
      ...
      firstOn: serializer.fromJson<String>(json['firstOn']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'firstOn': serializer.toJson<String>(firstOn),
      'everyMonths': serializer.toJson<int>(everyMonths),
      'note': serializer.toJson<String?>(note),
    };
  }

  OwnAppointmentsData copyWith({
    String? id,
    String? personId,
    String? title,
    String? firstOn,
  ...
  OwnAppointmentsData copyWithCompanion(OwnAppointmentsCompanion data) {
    return OwnAppointmentsData(
      id: data.id.present ? data.id.value : this.id,
      personId: data.personId.present ? data.personId.value : this.personId,
      title: data.title.present ? data.title.value : this.title,
      firstOn: data.firstOn.present ? data.firstOn.value : this.firstOn,
  ...
  @override
  String toString() {
    return (StringBuffer('OwnAppointmentsData(')
          ..write('id: $id, ')
          ..write('personId: $personId, ')
          ..write('title: $title, ')
          ..write('firstOn: $firstOn, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is OwnAppointmentsData &&
          other.id == this.id &&
          other.personId == this.personId &&
          other.title == this.title &&
          other.firstOn == this.firstOn &&
          other.everyMonths == this.everyMonths &&
          other.note == this.note);
}

class OwnAppointmentsCompanion extends UpdateCompanion<OwnAppointmentsData> {
  final Value<String> id;
  final Value<String> personId;
  final Value<String> title;
  final Value<String> firstOn;
  final Value<int> everyMonths;
  final Value<String?> note;
  final Value<int> rowid;
  const OwnAppointmentsCompanion({
    this.id = const Value.absent(),
    this.personId = const Value.absent(),
    this.title = const Value.absent(),
    this.firstOn = const Value.absent(),
  ...
  OwnAppointmentsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       firstOn = Value(firstOn),
       everyMonths = Value(everyMonths);
  static Insertable<OwnAppointmentsData> custom({
    Expression<String>? id,
    Expression<String>? personId,
    Expression<String>? title,
    Expression<String>? firstOn,
    ...
    return RawValuesInsertable({
      ...
      if (firstOn != null) 'first_on': firstOn,
  ...
  OwnAppointmentsCompanion copyWith({
    Value<String>? id,
    Value<String>? personId,
    Value<String>? title,
    Value<String>? firstOn,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (firstOn.present) {
      map['first_on'] = Variable<String>(firstOn.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('OwnAppointmentsCompanion(')
          ..write('id: $id, ')
          ..write('personId: $personId, ')
          ..write('title: $title, ')
          ..write('firstOn: $firstOn, ')
...
class DatabaseAtV6 extends GeneratedDatabase {
  ...
  late final OwnAppointments ownAppointments = OwnAppointments(this);
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('own_appointments', kind: UpdateKind.delete)],
    ),
  ]);
  @override
